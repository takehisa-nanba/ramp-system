...
from flask_jwt_extended import create_access_token, jwt_required, get_jwt # JWT関連を統合
from functools import wraps
from app.extensions import db # extensions のインポート
from app.models import Supporter, RoleMaster, SystemLog # models のインポート
